...
debate about how secure this app is and whether it is a good idea or not. This 
...
The first step will be to create some code that generates a random password. As  
long as we are generating passwords we might as well ask the question: what makes a good 
password? 

Generally speaking the strength of a password is related to the number of possible 
guesses it would take to solve it. 

If you used only numbers and made a password 
...
The next couple lessons study Numbers in JavaScript. Take a look at these 
live code samples and answer the questions here then read the sections 
below. 
